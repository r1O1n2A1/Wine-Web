 ...
 * 
 */
@WebServiceClient(name = "ServiceImageService", targetNamespace = "http://images.wine.al30.afcepf.fr", wsdlLocation = "http://192.168.102.70:28080/Wine-Utile-1.0.0/downloadUploadServices?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.102.70:28080/Wine-Utile-1.0.0/downloadUploadServices?wsdl");
